  ...
  return async function (req, ctx) {
    try {
      ...
      if (body && typeof body[field] === "string") {
        ...
        if (r.blocked) {
          return new Response(JSON.stringify({ error: "kaali_guard_blocked", reason: r.reason, threats: r.threats }), { status: 400, headers: { "content-type": "application/json" } });
        }
